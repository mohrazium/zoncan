...
class LightTheme {
  ...
  static InputDecorationTheme get inputDecorationTheme => InputDecorationTheme(
    ...
    focusedErrorBorder: OutlineInputBorder(
      borderSide: BorderSide(
        width: kBorderWith,
        color: Colorize.lightColorScheme.error,
      ),
      borderRadius: const BorderRadius.all(Radius.circular(kBorderRadius)),
    ),
    ...
    labelStyle: TextStyle(color: Colorize.lightColorScheme.primary),
  ...
  static ElevatedButtonThemeData get elevatedButtonThemeData =>
      ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          disabledForegroundColor: Colorize.lightColorScheme.onSurface
              .withOpacity(0.38),
          disabledBackgroundColor: Colorize.lightColorScheme.onSurface
              .withOpacity(0.12),
          shadowColor: Colorize.lightColorScheme.shadow,
          surfaceTintColor: Colorize.lightColorScheme.surfaceTint,
          elevation: 0.0,
          fixedSize: Size(
            180 * Fonts.instance.fontScale,
  ...
  static CheckboxThemeData get checkboxTheme => CheckboxThemeData(
    ...
    checkColor: WidgetStateProperty.all(Colorize.lightColorScheme.onPrimary),
    side: BorderSide(
      width: kBorderWith,
      color: Colorize.lightColorScheme.secondary,
