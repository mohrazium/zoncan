...
import 'package:zoncan/core/common/database/helper/zoncan_database.dart';
...
import 'package:zoncan/features/accounts/domain/entity/person_entity.dart';
import 'package:zoncan/features/accounts/domain/enums/person_type.dart';
...
class PersonTable extends Table {
  ...
  TextColumn get addressId =>
      text().nullable().references(AddressTable, #uid)();
